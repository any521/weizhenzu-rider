<template>
  <view v-if="visible" class="global-tabbar">
    <view class="tab-main">
      <view
...
const tabPaths = new Set([...leftTabs, centerTab, ...rightTabs].map(t => t.pagePath))

const visible = computed(() => tabPaths.has(tabStore.activeTab))

...
const icons: Record<string, string> = {
  ...
  settings: `<circle cx="24" cy="24" r="6" stroke="currentColor" stroke-width="2.5"/><path d="M38.8 30a3.3 3.3 0 0 0 .66 3.64l.12.12a4 4 0 0 1-5.66 5.66l-.12-.12a3.3 3.3 0 0 0-3.64-.66 3.3 3.3 0 0 0-2 3.02V42a4 4 0 0 1-8 0v-.18A3.3 3.3 0 0 0 18 38.8a3.3 3.3 0 0 0-3.64.66l-.12.12a4 4 0 0 1-5.66-5.66l.12-.12a3.3 3.3 0 0 0 .66-3.64 3.3 3.3 0 0 0-3.02-2H6a4 4 0 0 1 0-8h.18A3.3 3.3 0 0 0 9.2 18a3.3 3.3 0 0 0-.66-3.64l-.12-.12a4 4 0 0 1 5.66-5.66l.12.12a3.3 3.3 0 0 0 3.64.66H18a3.3 3.3 0 0 0 2-3.02V6a4 4 0 0 1 8 0v.18a3.3 3.3 0 0 0 2 3.02 3.3 3.3 0 0 0 3.64-.66l.12-.12a4 4 0 0 1 5.66 5.66l-.12.12a3.3 3.3 0 0 0-.66 3.64V18a3.3 3.3 0 0 0 3.02 2H42a4 4 0 0 1 0 8h-.18a3.3 3.3 0 0 0-3.02 2Z" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>`,
  ...
  // 订单状态补充图标
  cooking: `<path d="M16 14c0-4 4-6 8-6s8 2 8 6v6H16v-6Z" stroke="currentColor" stroke-width="2.5" stroke-linejoin="round"/><path d="M12 20h24v14a4 4 0 0 1-4 4H16a4 4 0 0 1-4-4V20Z" stroke="currentColor" stroke-width="2.5" stroke-linejoin="round"/><path d="M20 28h2M26 28h2" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/><path d="M22 34h4" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>`,
  bike: `<circle cx="14" cy="34" r="6" stroke="currentColor" stroke-width="2.5"/><circle cx="34" cy="34" r="6" stroke="currentColor" stroke-width="2.5"/><path d="M14 34l6-14h10l4 14" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M20 20h4l2-6" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M28 20l-4 14" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/>`,
}
